...
import restaurante.domain.entity.Produto;
import restaurante.dto.ProdutoRequest;
import restaurante.dto.ProdutoResponse;
import org.springframework.data.domain.Page;
import org.springframework.stereotype.Service;
import restaurante.repository.CategoriaProdutoRepository;
...
public class ProdutoService {
    ...
    private CategoriaProduto buscarCategoriaPorId(Long id) {
        return categoriaProdutoRepository.findById(id).orElseThrow(() -> new RuntimeException("Categoria nao encontrada."));
    }
